...
class InvoiceHeaderTest {
    ...
    private static final Address BUSINESS_ADDRESS = new Address("123 Main", "Seattle", StateCode.WA, "1228");
    private static final ClientAccount BUSINESS_CLIENT = new ClientAccount("Some Client", new PersonalName("Jim", "Jones"), BUSINESS_ADDRESS);
    ...
    @Test
    void testToString() {
        String expected = "InvoiceHeader{businessName=' Some Business', businessAddress=123 Main\n" +
    ...
    @BeforeEach
    void setUp() {
        invoiceHeader = new InvoiceHeader(BUSINESS_NAME, BUSINESS_ADDRESS, BUSINESS_CLIENT, INVOICE_DATE, INVOICE_DATE_FOR_MONTH);
    }
