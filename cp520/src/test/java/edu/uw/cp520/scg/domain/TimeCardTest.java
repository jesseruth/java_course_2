...
class TimeCardTest {
    ...
    private final ConsultantTime consultantTime1 = new ConsultantTime(startDay, billableAccount, Skill.PROJECT_MANAGER, 3);
    private final ConsultantTime consultantTime2 = new ConsultantTime(startDay, billableAccount, Skill.SOFTWARE_TESTER, 2);
    private final ConsultantTime consultantTime3 = new ConsultantTime(startDay, billableAccount, Skill.SYSTEM_ARCHITECT, 1);
    ...
    private final ConsultantTime consultantTime4 = new ConsultantTime(startDay, nonBillableAccount, Skill.PROJECT_MANAGER, 3);
    private final ConsultantTime consultantTime5 = new ConsultantTime(startDay, nonBillableAccount, Skill.SOFTWARE_TESTER, 2);
    private final ConsultantTime consultantTime6 = new ConsultantTime(startDay, nonBillableAccount, Skill.SYSTEM_ARCHITECT, 1);
    ...
    void setup() {
        ...
        thirdTimeCard = new TimeCard(new Consultant(new PersonalName("Joe", "Bob")), startDay2);
    }
    ...
    void getTotalBillableHoursForClient() {
        ...
        final ConsultantTime consultantTime4 = new ConsultantTime(startDay, billableAccount2, Skill.SOFTWARE_TESTER, 2);
        final ConsultantTime consultantTime5 = new ConsultantTime(startDay, billableAccount2, Skill.SYSTEM_ARCHITECT, 1);

        // Add a non-billable account
        final ConsultantTime consultantTime6 = new ConsultantTime(startDay, NonBillableAccount.VACATION, Skill.SYSTEM_ARCHITECT, 1);
    ...
    void getTotalBillableHoursForClientWithNonbillable() {
        ...
        // Add some time
        final ConsultantTime consultantTime1 = new ConsultantTime(startDay, oddVacationAccount, Skill.PROJECT_MANAGER, 3);
        final ConsultantTime consultantTime6 = new ConsultantTime(startDay, NonBillableAccount.VACATION, Skill.SYSTEM_ARCHITECT, 1);
        timeCard.addConsultantTime(consultantTime1);
        timeCard.addConsultantTime(consultantTime6);
    ...
    void getConsultingHours() {
        // Add some time
        final ConsultantTime consultantTime1 = new ConsultantTime(startDay, billableAccount, Skill.PROJECT_MANAGER, 3);
        final ConsultantTime consultantTime2 = new ConsultantTime(startDay, billableAccount, Skill.SOFTWARE_TESTER, 2);
        final ConsultantTime consultantTime3 = new ConsultantTime(startDay, billableAccount, Skill.SYSTEM_ARCHITECT, 1);
        timeCard.addConsultantTime(consultantTime1);
    ...
    void testCompareTo() {
        ...
        final ConsultantTime consultantTime1 = new ConsultantTime(startDay2, nonBillableAccount, Skill.PROJECT_MANAGER, 3);
        final ConsultantTime consultantTime2 = new ConsultantTime(startDay, billableAccount, Skill.PROJECT_MANAGER, 3);
