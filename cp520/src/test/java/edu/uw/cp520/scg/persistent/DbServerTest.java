...
class DbServerTest {
    ...
    void setUp() throws Exception {
        ...
        server = EmbeddedNetworkServer.createServerFromDdl(dbName, ddlReader, username, password, true, false);
        dbServer = new DbServer("jdbc:derby://localhost:1527/memory:scgDb", username, password);
    ...
    void addAndGetClient() {
        ...
        ClientAccount clientAccount = new ClientAccount("Account", new PersonalName("Jim", "Bob"), address);
