...
class AddressTest {
    ...
    void testEquals() {
        ...
        assertEquals((new Address(null, city, state, postalCode)), new Address(null, city, state, postalCode));
        assertEquals((new Address(streetNumber, null, state, postalCode)), new Address(streetNumber, null, state, postalCode));
        assertEquals((new Address(streetNumber, city, null, postalCode)), new Address(streetNumber, city, null, postalCode));
        assertEquals((new Address(streetNumber, city, state, null)), new Address(streetNumber, city, state, null));
