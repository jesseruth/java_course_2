 ...
 */
public final class TimeCardListUtilRussTest {
    ...
    public void setUp() {
        ...
        final Consultant systemAnalyst = new Consultant(
            new PersonalName("Architect", "Ann", "S.")
        );
    ...
    public void testGetTimeCardsForDateRange() {
        ...
        final List<TimeCard> selected = TimeCardListUtil.getTimeCardsForDateRange(
            timeCards,
            dateRange
        );
