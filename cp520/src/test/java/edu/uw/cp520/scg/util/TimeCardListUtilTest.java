...
class TimeCardListUtilTest {
    ...
    private final PersonalName person1 = new PersonalName(
        firstName,
        middleName,
        lastName
    );
    private final Consultant consultant1 = new Consultant(
        new PersonalName("Adam", "Adams")
    );
    private final Consultant consultant2 = new Consultant(
        new PersonalName("Middle", "Matt")
    );
    private final Consultant consultant3 = new Consultant(
        new PersonalName("Zim", "Zebra")
    );
    ...
    void getTimeCardsForConsultant() {
        List<TimeCard> actual = TimeCardListUtil.getTimeCardsForConsultant(
            timeCardList,
            consultant1
        );
    ...
    void sortByStartDate() {
        ...
        String actual = timeCardList
            .stream()
            .map(timeCard -> timeCard.toString())
            .collect(Collectors.joining());
        assertEquals(
            "Matt, Middle NMN 1927-05-05Adams, Adam NMN 1900-05-05Zebra, Zim NMN 1999-05-05",
            actual
        );
        ...
        assertEquals(
            "Adams, Adam NMN 1900-05-05Matt, Middle NMN 1927-05-05Zebra, Zim NMN 1999-05-05",
            actual
        );
    }
