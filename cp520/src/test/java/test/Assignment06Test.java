...
public final class Assignment06Test {
  ...
  private static class TestPropertyListener
  ...
  public void setUp() {
    ...
    staffConsultant =
      new StaffConsultant(
        new PersonalName("Coder", "Kalvin"),
        CODER_INITIAL_PAY_RATE,
    ...
    consultantList.add(
      new StaffConsultant(
        new PersonalName("Architect", "Amber", "K."),
        ARCHITECT_INITIAL_PAY_RATE,
        INITIAL_SICK_LEAVE_HOURS,
        INITIAL_VACATION_HOURS
      )
    );
    consultantList.add(
      new StaffConsultant(
        new PersonalName("Tester", "Teddy", "B."),
        TESTER_INITIAL_PAY_RATE,
        INITIAL_SICK_LEAVE_HOURS,
        INITIAL_VACATION_HOURS
      )
    );
    consultantList.add(
      new StaffConsultant(
        new PersonalName("Engineer", "Ernie"),
        ENGINEER_INITIAL_PAY_RATE,
        INITIAL_SICK_LEAVE_HOURS,
        INITIAL_VACATION_HOURS
      )
    );
  ...
  public void testBenefits() {
    ...
    assertEquals(
      consultantList.get(MEDICAL_ENROLLEE),
      testBenefitListener.medicalEnrollConsultant
    );
    assertEquals(
      consultantList.get(DENTAL_ENROLLEE),
      testBenefitListener.dentalEnrollConsultant
    );
    assertEquals(
      consultantList.get(MEDICAL_CANCEL),
      testBenefitListener.medicalCancelConsultant
    );
    assertEquals(
      consultantList.get(DENTAL_CANCEL),
      testBenefitListener.dentalCancelConsultant
    );
  }
}
